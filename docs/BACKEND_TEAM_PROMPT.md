...
- 일간 24시간·주간 168시간·월간 720시간 기간 순위를 제공하고 주간을 기본 호환 화면으로 사용합니다.
...
- 전체 순위가 1부터 연속인지
- 각 기간 점수가 기간강도 40 + 비교기간 모멘텀 20 + 출처별 지속성 20 + 마지막 관측 신선도 15 + 기간 내 교차출처 5인지
- 기간강도가 원천별 `70% 신선도 가중 평균 + 30% 최고점`이고, 비교 원장이 없을 때 모멘텀이 중립 처리되는지
