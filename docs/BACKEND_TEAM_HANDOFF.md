...
- Company Gold: 증거 경로 완결 + 국내 상장기업 5개 이상
...
2. 전체 현재 순위는 제한 없이 `unified_ranking`에 보존
3. 표시 필터·카테고리·기사·기업은 점수 변경 금지
4. 기사 발견어는 X/Google 실제 관측 전 순위 삽입 금지
5. 기업 5개 미달이면 `ontology_incomplete`, filler 금지
...
- 온톨로지 5개 미달 트렌드의 공식·기사·IR 근거 edge 추가
