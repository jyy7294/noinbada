...
2. At least ten unique listed companies with a stock code, market, company
...
queue prioritises these gaps with required counts of five keywords and ten
companies.
...
transport eligibility and never changes the X+Google score or observed rank.
