...
flowchart LR
    ...
    G["뉴스·네이버·네이트·YouTube"] --> E
    G -. "순위에는 영향 없음" .-> D
```

- 순위 입력: X와 Google만 사용합니다.
- 보조 조사: 공식 발표, 뉴스, 네이버·네이트, YouTube, 관련 검색어를 사용하되 순위 점수는 바꾸지 않습니다.
...
1. **오늘의 트렌드 Top10**: 최근 24시간의 관심 강도, 상승 속도, 교차 확산, 지속성, 최신성을 계산합니다.
