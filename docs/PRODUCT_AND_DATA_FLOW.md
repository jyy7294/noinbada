...
7. **언급량 추이·관심지수**: X·Google에서 실제 관측된 정규화 관심지수 점만 1주·1개월·3개월 창으로 제공합니다. 결측 구간은 선을 끊고 임의 상승·보간·이전값 재사용을 하지 않습니다.
...
- 공개 항목마다 관련어 정확히 5개, 검증 상장기업 정확히 10개, 역할 카테고리 2~4개, 기업과 연결되는 서로 다른 키워드 2개 이상
