...
VERIFIED_COMPANIES = {
    ...
    "말복": (
        ...
        {
            "company": "동원산업", "ticker": "006040", "market": "KRX",
            "company_description": "동원그룹 식품사업을 지배하고 양반 브랜드 보양 간편식 사업을 연결하는 상장기업",
            "company_role_category": "ownership_investment",
            "relation_tier": "value_chain", "reason": "동원그룹 공식 자료가 양반 통다리 삼계탕 출시와 동원F&B 식품사업을 설명",
        ...
        {
            "company": "마니커에프앤지", "ticker": "195500", "market": "KOSDAQ",
            "company_description": "삼계탕을 포함한 레토르트 HMR 제품을 생산·수출하는 상장 식품기업",
            "company_role_category": "manufacturing_development",
            "relation_tier": "direct", "reason": "공식 회사소식이 삼계탕 등 레토르트 제품 생산과 수출 계획을 직접 설명",
            "evidence_url": "https://www.manikerfng.com/bbs/board.php?bo_table=notice&wr_id=64",
            "evidence_owner": "마니커에프앤지", "evidence_type": "official_company_release",
        },
    ),
    "아이폰": (
        {
