...
def test_home_feed_is_rank_free_and_groups_positive_cross_platform_candidate():
    item = {
        ...
        "companies": [_company(i, "platform" if i < 5 else "brand_marketing") for i in range(10)],
        "company_eligible": True, "trend_definition": "X와 Google 한국 관측을 바탕으로 한 테스트 정의이며 투자 추천이나 수익 예측을 제공하지 않습니다.",
